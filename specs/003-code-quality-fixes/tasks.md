...
- [X] T033 [P] [M8] Add IDisposable to ProfileSelectorViewModel if it subscribes to events in src/ReqChecker.App/ViewModels/ProfileSelectorViewModel.cs (N/A - ProfileSelectorViewModel doesn't subscribe to events)
